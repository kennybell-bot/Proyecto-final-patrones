...
function Body(){
    return(
        <div className="cuerpo">
            ...
            <h1>Bienvenidos a Artesanías Bogotá</h1>
            <Collage></Collage>
            <p className="parrafoBienvenida">En el corazón de la capital colombiana, nos dedicamos a crear piezas únicas que reflejan nuestra rica herencia cultural y la belleza de las tradiciones artesanales. Cada una de nuestras creaciones es un testimonio del talento y la dedicación de nuestros artesanos, quienes han perfeccionado su oficio a lo largo de generaciones.Desde vibrantes tejidos hasta cerámicas detalladas, en Artesanías Bogotá encontrarás una amplia variedad de productos hechos a mano que capturan el espíritu y la esencia de Colombia.</p>
